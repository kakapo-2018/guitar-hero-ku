      ...
      <div className="keyChordContainer">
        <div className="keys">
          <div className='keyRow'>
            <input className='topRowKeys' id='c-key' type='button' value='C' onClick={() => this.props.displayChord()}></input>
            <input className='topRowKeys' id='d-key' type='button' value='D' onClick={() => this.props.displayChord()}></input>
