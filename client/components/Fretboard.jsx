  ...
  return (
    ...
    <div className="string" id="0-string">
      ...
      <div className="string" id="first-string">
        ...
        <div className="fret string1 fret2" string="1" fret="2" note="Fsharp Gflat" scinote="F4sharp G4flat" id="fret2-string1">F#/Gb</div>
        <div className="fret string1 fret3" string="1" fret="3" note="G" scinote="G4" id="fret3-string1">G</div>
        <div className="fret string1 fret4" string="1" fret="4" note="Gsharp Aflat" scinote="G4sharp A4flat" id="fret4-string1">G#/Ab</div>
        <div className="fret string1 fret5" string="1" fret="5" note="A" scinote="A4" id="fret5-string1">A</div>
        <div className="fret string1 fret6" string="1" fret="6" note="Asharp Bflat" scinote="A4sharp B4flat" id="fret6-string1">A#/Bb</div>
        ...
        <div className="fret string1 fret9" string="1" fret="9" note="Csharp Dflat" scinote="C5sharp D5flat" id="fret9-string1">C#/Db</div>
        <div className="fret string1 fret10" string="1" fret="10" note="D" scinote="D5" id="fret10-string1">D</div>
        <div className="fret string1 fret11" string="1" fret="11" note="Dsharp Eflat" scinote="D5sharp E5flat" id="fret11-string1">D#/Eb</div>
      ...
      <div className="string" id="second-string">
        ...
        <div className="fret string2 fret2" string="2" fret="2" note="Csharp Dflat" scinote="C4sharp D4flat" id="fret2-string2">C#/Db</div>
        <div className="fret string2 fret3" string="2" fret="3" note="D" scinote="D4" id="fret3-string2">D</div>
        <div className="fret string2 fret4" string="2" fret="4" note="Dsharp Eflat" scinote="D4sharp E4flat" id="fret4-string2">D#/Eb</div>
        ...
        <div className="fret string2 fret7" string="2" fret="7" note="Fsharp Gflat" scinote="F4sharp G4flat" id="fret7-string2">F#/Gb</div>
        <div className="fret string2 fret8" string="2" fret="8" note="G" scinote="G4" id="fret8-string2">G</div>
        <div className="fret string2 fret9" string="2" fret="9" note="Gsharp Aflat" scinote="G4sharp A4flat" id="fret9-string2">G#/Ab</div>
        <div className="fret string2 fret10" string="2" fret="10" note="A" scinote="A4" id="fret10-string2">A</div>
        <div className="fret string2 fret11" string="2" fret="11" note="Asharp Bflat" scinote="A4sharp B4flat" id="fret11-string2">A#/Bb</div>
      ...
      <div className="string" id="third-string">
        ...
        <div className="fret string3 fret1" string="3" fret="1" note="Gsharp Aflat" scinote="G3sharp A3flat" id="fret1-string3">G#/Ab</div>
        <div className="fret string3 fret2" string="3" fret="2" note="A" scinote="A3" id="fret2-string3">A</div>
        <div className="fret string3 fret3" string="3" fret="3" note="Asharp Bflat" scinote="A3sharp B3flat" id="fret3-string3">A#/Bb</div>
        ...
        <div className="fret string3 fret6" string="3" fret="6" note="Csharp Dflat" scinote="C4sharp D4flat" id="fret6-string3">C#/Db</div>
        <div className="fret string3 fret7" string="3" fret="7" note="D" scinote="D4" id="fret7-string3">D</div>
        <div className="fret string3 fret8" string="3" fret="8" note="Dsharp E4flat" scinote="D4sharp E4flat" id="fret8-string3">D#/Eb</div>
        ...
        <div className="fret string3 fret11" string="3" fret="11" note="Fsharp Gflat" scinote="F4sharp G4flat" id="fret11-string3">F#/Gb</div>
      ...
      <div className="string" id="fourth-string">
        ...
        <div className="fret string4 fret1" string="4" fret="1" note="Dsharp Eflat" scinote="D3sharp E3flat" id="fret1-string4">D#/Eb</div>
        ...
        <div className="fret string4 fret4" string="4" fret="4" note="Fsharp Gflat" scinote="F3sharp G3flat" id="fret4-string4">F#/Gb</div>
        <div className="fret string4 fret5" string="4" fret="5" note="G" scinote="G3" id="fret5-string4">G</div>
        <div className="fret string4 fret6" string="4" fret="6" note="Gsharp Aflat" scinote="G3sharp A3flat" id="fret6-string4">G#/Ab</div>
        <div className="fret string4 fret7" string="4" fret="7" note="A" scinote="A3" id="fret7-string4">A</div>
        <div className="fret string4 fret8" string="4" fret="8" note="Asharp Bflat" scinote="A3sharp B3flat" id="fret8-string4">A#/Bb</div>
        ...
        <div className="fret string4 fret11" string="4" fret="11" note="Csharp Dflat" scinote="C4sharp D4flat" id="fret11-string4">C#/Db</div>
      ...
      <div className="string" id="fifth-string">
        ...
        <div className="fret string5 fret1" string="5" fret="1" note="Asharp Bflat" scinote="A2sharp B2flat" id="fret1-string5">A#/Bb</div>
        ...
        <div className="fret string5 fret4" string="5" fret="4" note="Csharp Dflat" scinote="C3sharp D3flat" id="fret4-string5">C#/Db</div>
        <div className="fret string5 fret5" string="5" fret="5" note="D" scinote="D3" id="fret5-string5">D</div>
        <div className="fret string5 fret6" string="5" fret="6" note="Dsharp Eflat" scinote="D3sharp E3flat" id="fret6-string5">D#/Eb</div>
        ...
        <div className="fret string5 fret9" string="5" fret="9" note="Fsharp Gflat" scinote="F3sharp G3flat" id="fret9-string5">F#/Gb</div>
        <div className="fret string5 fret10" string="5" fret="10" note="G" scinote="G3" id="fret10-string5">G</div>
        <div className="fret string5 fret11" string="5" fret="11" note="Gsharp Aflat" scinote="G3sharp A3flat" id="fret11-string5">G#/Ab</div>
      ...
      <div className="string" id="sixth-string">
        ...
        <div className="fret string6 fret2" string="6" fret="2" note="Fsharp Gflat" scinote="F2sharp G2flat" id="fret2-string6">F#/Gb</div>
        <div className="fret string6 fret3" string="6" fret="3" note="G" scinote="G2" id="fret3-string6">G</div>
        <div className="fret string6 fret4" string="6" fret="4" note="Gsharp Aflat" scinote="G2sharp A2flat" id="fret4-string6">G#/Ab</div>
        <div className="fret string6 fret5" string="6" fret="5" note="A" scinote="A2" id="fret5-string6">A</div>
        <div className="fret string6 fret6" string="6" fret="6" note="Asharp Bflat" scinote="A2sharp B2flat" id="fret6-string6">A#/Bb</div>
        ...
        <div className="fret string6 fret9" string="6" fret="9" note="Csharp Dflat" scinote="C3sharp D3flat" id="fret9-string6">C#/Db</div>
