  ...
  return(
    ...
    <div className="wholething"> */}
      ...
      <div className="string" id="second-string">
        ...
        <div className="fret string2 fret2 Csharp Dflat C4sharp D4flat sharp-or-flat guitarnote" id="fret2-string2">C#</div>
      ...
      <div className="string" id="third-string">
        ...
        <div className="fret string3 fret2 A A3 guitarnote2" id="fret2-string3">A</div>
      ...
      <div className="string" id="fourth-string">
        ...
        <div className="fret string4 fret2 E E3 guitarnote2" id="fret2-string4">E</div>
      ...
      <div className="string" id="fifth-string">
        ...
        <div className="fret string5 fret2 B B2 guitarnote2" id="fret2-string5">B</div>
      ...
      <div className="string" id="sixth-string">
        ...
        <div className="fret string6 fret2 Fsharp Gflat F2sharp G2flat sharp-or-flat guitarnote2" id="fret2-string6">F#</div>
      ...
      <div className="string" id="seventh-string">
        <div className="fret string7 fret0" id="fret0-string7">w</div>
        <div className="fret string7 fret1" id="fret1-string7">r</div>
        <div className="fret string7 fret2" id="fret2-string7">f</div>
        <div className="fret string7 fret3" id="fret3-string7"></div>
        <div className="fret string7 fret4" id="fret4-string7"></div>
        <div className="fret string7 fret5" id="fret5-string7"></div>
        <div className="fret string7 fret6" id="fret6-string7"></div>
        <div className="fret string7 fret7" id="fret7-string7"></div>
        <div className="fret string7 fret8" id="fret8-string7"></div>
        <div className="fret string7 fret9" id="fret9-string7"></div>
        <div className="fret string7 fret10" id="fret10-string7"></div>
        <div className="fret string7 fret11" id="fret11-string7"></div>
        <div className="fret string7 fret12" id="fret12-string7"></div>


      {/* <div className="string" id="seventh-string">
        <div className="fret string7"></div> */}
